...
export const metadata: Metadata = {
  title: '美容食Lab',
  description: '美容食・スーパーフード情報',
  openGraph: { title: '美容食Lab', description: '美容食・スーパーフード情報', type: 'website', locale: 'ja_JP', siteName: '美容食Lab' },
  twitter: { card: 'summary_large_image', title: '美容食Lab', description: '美容食・スーパーフード情報' },
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "美容食Lab", "description": "美容食・スーパーフード情報", "url": "https://beauty-food-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}
